...
export default function WebsocketController() {
    ...
    const handleSliderChange = useCallback((e: React.ChangeEvent<HTMLInputElement>, motor: 'A' | 'B') => {
        const value = parseInt(e.target.value);
        console.log(`Slider ${motor} changed:`, value);
    ...
    useEffect(() => {
        const setupJoystick = (
            ...
            const updateSliderValue = (clientY: number) => {
                ...
                slider.value = Math.round(value).toString();
            ...
            return () => {
                // Cleanup
                joystick.removeEventListener('mousedown', (e) => {
                    e.preventDefault();
                    handleStart(e.clientY);
                });
        ...
        const cleanupA = setupJoystick(joystickARef, sliderARef, 'A');
        const cleanupB = setupJoystick(joystickBRef, sliderBRef, 'B');
                            ...
                            <div className="motor-control motor-a">
                                <div className="joystick-container" ref={joystickARef}>
                                    <input
                                        ...
                                        onInput={(e) => handleSliderChange(e as React.ChangeEvent<HTMLInputElement>, 'A')}
                                        onMouseUp={() => {
                                            if (motorAChangeRef.current) clearTimeout(motorAChangeRef.current);
                                            handleMotorAControl(0, 'stop');
                                        }}
                            ...
                            <div className="motor-control motor-b">
                                <div className="joystick-container" ref={joystickBRef}>
                                    <input
                                        ...
                                        onInput={(e) => handleSliderChange(e as React.ChangeEvent<HTMLInputElement>, 'B')}
                                        onMouseUp={() => {
                                            if (motorBChangeRef.current) clearTimeout(motorBChangeRef.current);
                                            handleMotorBControl(0, 'stop');
                                        }}
